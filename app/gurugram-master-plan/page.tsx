  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="w-full py-16 md:py-24 px-4 bg-gradient-to-br from-[#125007] to-[#4a7c2e] text-white">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button asChild size="lg" className="bg-white text-[#125007] hover:bg-blue-50">
        ...
        {/* CTA */}
        <section className="w-full py-16 px-4 bg-gradient-to-br from-[#125007] to-[#4a7c2e] text-white">
