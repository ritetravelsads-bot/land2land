      ...
      <div className="flex-1 bg-gradient-to-b from-green-50 to-white">
        ...
        <section className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 mb-12">
            <h2 className="text-xl font-bold text-[#125007] mb-6">Filter Farms</h2>
          ...
          {/* Farm Types Grid */}
          <h2 className="text-3xl font-bold text-[#125007] mb-8">Types of Farms Available</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {FARM_TYPES.map((farm) => (
              <div key={farm.name} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-6 border-l-4 border-[#125007]">
                <div className="text-5xl mb-4">{farm.icon}</div>
                <h3 className="text-xl font-bold text-[#125007] mb-2">{farm.name}</h3>
                ...
                <div className="space-y-1 mb-4">
                  ...
                  {farm.benefits.map((benefit) => (
                    <p key={benefit} className="text-xs text-gray-600 flex items-center gap-2">
                      <span className="text-[#125007]">✓</span> {benefit}
                    </p>
                  ))}
                </div>
                <Link
                  href={`/properties?category=farmland&farm_type=${farm.name.toLowerCase().replace(" ", "_")}`}
                  className="text-[#125007] font-semibold hover:text-[#1d3610] transition-colors inline-flex items-center gap-1"
                >
                  Browse → 
                </Link>
              </div>
          ...
          {/* Featured Farms */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-[#125007] mb-8">Featured Farms</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredFarms.map((farm) => (
                <div key={farm.id} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow overflow-hidden">
                  {/* Header Card */}
                  <div className="bg-gradient-to-r from-[#125007] to-[#4a7c2e] text-white p-4">
                  ...
                  <div className="p-6 space-y-4">
                    <div className="flex items-center gap-2 text-gray-600">
                      <MapPin className="h-4 w-4 text-[#125007]" />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 bg-green-50 rounded-lg">
                        ...
                        <p className="text-lg font-bold text-[#125007]">{farm.size} {farm.sizeUnit}</p>
                      </div>
                      <div className="p-3 bg-green-50 rounded-lg">
                        <p className="text-xs text-gray-600 mb-1">Yield</p>
                        <p className="text-lg font-bold text-[#125007]">{farm.yield}</p>
                      </div>
                    </div>
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      ...
                      <p className="text-2xl font-bold text-[#125007]">₹{(farm.price / 100000).toFixed(1)}L</p>
                    </div>

                    <button className="w-full bg-[#125007] hover:bg-[#1d3610] text-white font-semibold py-2 rounded-lg transition-colors">
                      View Details
                    </button>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-lg shadow p-8 mb-12">
            <h2 className="text-2xl font-bold text-[#125007] mb-6">Why Invest in Farms?</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="inline-flex items-center justify-center h-16 w-16 rounded-full bg-green-100 mb-4">
                  <TrendingUp className="h-8 w-8 text-[#125007]" />
                </div>
                <h3 className="font-bold text-[#125007] mb-2">Capital Appreciation</h3>
                <p className="text-sm text-gray-600">Land values grow 8-12% annually in agricultural belts</p>
              </div>
              <div className="text-center">
                <div className="inline-flex items-center justify-center h-16 w-16 rounded-full bg-green-100 mb-4">
                  <DollarSign className="h-8 w-8 text-[#125007]" />
                </div>
                <h3 className="font-bold text-[#125007] mb-2">Regular Income</h3>
                <p className="text-sm text-gray-600">Seasonal or year-round income from crops and livestock</p>
              </div>
              <div className="text-center">
                <div className="inline-flex items-center justify-center h-16 w-16 rounded-full bg-green-100 mb-4">
                  <Tractor className="h-8 w-8 text-[#125007]" />
                </div>
                <h3 className="font-bold text-[#125007] mb-2">Sustainable</h3>
                <p className="text-sm text-gray-600">Build a legacy with productive agricultural assets</p>
              </div>
              <div className="text-center">
                <div className="inline-flex items-center justify-center h-16 w-16 rounded-full bg-green-100 mb-4">
                  <Award className="h-8 w-8 text-[#125007]" />
                </div>
                <h3 className="font-bold text-[#125007] mb-2">Government Support</h3>
