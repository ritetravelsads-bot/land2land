            ...
            {siteMapSections.map((section) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 bg-[#125007]/10 rounded-lg">
                    <section.icon className="h-5 w-5 text-[#125007]" />
                  </div>
                ...
                <ul className="space-y-2">
                  {section.links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="flex items-center gap-2 text-gray-600 hover:text-[#125007] transition-colors py-1"
                      >
