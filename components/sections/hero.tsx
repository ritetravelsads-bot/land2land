  ...
  return (
    <section className="relative w-full h-screen flex items-center overflow-hidden">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#125007]/95 via-[#125007]/85 to-transparent" />
      </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-14 pr-5 py-4 border-2 border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#125007] focus:border-transparent text-base"
                />
              </div>

              <div className="flex-1 relative">
                <Home className="absolute left-5 top-1/2 -translate-y-1/2 text-muted-foreground" size={20} />
                <select className="w-full pl-14 pr-5 py-4 border-2 border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#125007] focus:border-transparent text-base appearance-none bg-white">
              ...
              <Button
                size="lg"
                className="md:w-auto w-full bg-[#125007] hover:bg-[#003388] h-14 text-base font-semibold rounded-xl"
              >
