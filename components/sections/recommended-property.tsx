...
export default function RecommendedProperty() {
  ...
  return (
    <section className="w-full py-16 md:py-24 px-4 md:px-6 lg:px-8 bg-gradient-to-b from-white to-muted/30">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#125007]/10 mb-4">
            <TrendingUp className="w-5 h-5 text-[#125007]" />
            <span className="text-sm font-semibold text-[#125007]">Most Popular</span>
          </div>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-[#125007]">Recommended Properties</h2>
            ...
            >
              <div className="relative h-[450px] rounded-2xl overflow-hidden bg-white shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
                ...
                <div className="relative h-[280px] overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#125007]/20 to-transparent z-10 opacity-0 hover:opacity-100 transition-opacity duration-500" />
                  <img
                  ...
                  <div className="absolute top-4 right-4 z-20">
                    <div className="bg-gradient-to-r from-[#125007] to-[#003399] text-white px-4 py-2 rounded-full text-xs font-bold shadow-lg transform transition-all duration-500 hover:scale-110 hover:rotate-3">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 hover:opacity-100 transition-all duration-500 z-20 flex items-center justify-center">
                    <div className="transform translate-y-4 hover:translate-y-0 transition-transform duration-500">
                      <div className="bg-white text-[#125007] px-6 py-3 rounded-full font-semibold flex items-center gap-2 shadow-xl">
                        View Details
                ...
                <div className="p-5 relative">
                  ...
                  <div className="mb-3">
                    <h3 className="font-bold text-lg mb-1 text-gray-900 line-clamp-1 hover:text-[#125007] transition-colors duration-300">
                      {property.property_name}
                    </h3>
                    <div className="h-0.5 w-0 bg-gradient-to-r from-[#125007] to-[#003399] hover:w-full transition-all duration-500" />
                  </div>

                  {/* Location */}
                  <div className="flex items-start gap-2 mb-4 text-sm text-muted-foreground">
                    <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0 text-[#125007]" />
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4 pb-4 border-b border-gray-100">
                    <div className="flex flex-col items-center gap-1">
                      <Bed className="w-4 h-4 text-[#125007] transform hover:scale-110 transition-transform" />
                      <span className="text-xs font-semibold text-gray-700">
                        {property.bedrooms_min}-{property.bedrooms_max} BHK
                      </span>
                    </div>
                    <div className="flex flex-col items-center gap-1">
                      <Bath className="w-4 h-4 text-[#125007] transform hover:scale-110 transition-transform" />
                      <span className="text-xs font-semibold text-gray-700">{property.bathrooms_min}+ Bath</span>
                    </div>
                    <div className="flex flex-col items-center gap-1">
                      <Maximize className="w-4 h-4 text-[#125007] transform hover:scale-110 transition-transform" />
                  ...
                  <div className="relative overflow-hidden rounded-lg">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#125007] to-[#003399] transform -translate-x-full hover:translate-x-0 transition-transform duration-500" />
                    <div className="relative px-3 py-2 text-center">
                      ...
                      <div className="text-xl font-bold text-[#125007] hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-[#125007] via-[#003399] to-[#125007] transform scale-x-0 hover:scale-x-100 transition-transform duration-500 origin-left" />
              </div>
            </Link>
          ))}
        </div>
