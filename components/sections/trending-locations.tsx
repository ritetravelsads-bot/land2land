    ...
    <section className="py-16 px-4 md:px-6 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-center gap-3 mb-3">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#125007] text-center">Prime Investment Corridors</h2>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
          {trendingLocations.map((location) => (
            ...
            >
              ...
              <div className="absolute top-2 right-2 md:top-3 md:right-3 bg-[#125007] text-white text-[10px] md:text-xs font-semibold px-2 md:px-3 py-0.5 md:py-1 rounded-full">
                Trending
              </div>
            </Link>
          ))}
