    ...
    <section className="w-full py-16 md:py-24 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-14">
          <h2 className="text-3xl md:text-4xl font-bold text-[#125007] mb-3">Recommended Properties in Gurugram</h2>
            ...
            <Link key={property._id} href={getPropertyUrl(property)}>
              <div className="h-full rounded-xl overflow-hidden bg-white border border-gray-200 shadow-sm hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 cursor-pointer">
                ...
                <div className="p-5 space-y-4">
                  {/* Title & Location */}
                  <div>
                    <h3 className="text-lg font-bold text-[#125007] hover:text-red-500 transition-colors duration-300 line-clamp-1">
                  ...
                  {/* Price */}
                  <div className="bg-gradient-to-r from-[#125007]/5 to-red-500/5 rounded-lg p-3">
                    <p className="text-xs text-gray-500 mb-1">Starting From</p>
                    <div className="flex items-center gap-1">
                      <IndianRupee size={16} className="text-red-500" />
                      <p className="text-lg font-bold text-[#125007]">
                    ...
                    {property.bhk_count && (
                      <div className="text-center">
                        <div className="flex items-center justify-center gap-1 text-gray-600 mb-1">
                          <Bed size={14} className="text-[#125007]" />
                        </div>
                        <p className="text-xs font-semibold text-[#125007]">{property.bhk_count} BHK</p>
                      </div>
                    )}
                    {property.bathroom_count && (
                      <div className="text-center">
                        <div className="flex items-center justify-center gap-1 text-gray-600 mb-1">
                          <Bath size={14} className="text-[#125007]" />
                        </div>
                        <p className="text-xs font-semibold text-[#125007]">{property.bathroom_count} Bath</p>
                      </div>
                    )}
                    {property.area && (
                      <div className="text-center">
                        <div className="flex items-center justify-center gap-1 text-gray-600 mb-1">
                          <Square size={14} className="text-[#125007]" />
                        </div>
                        <p className="text-xs font-semibold text-[#125007]">
                  ...
                  {property.developer_name && (
                    <div className="pt-2 border-t border-gray-100">
                      <p className="text-xs text-gray-500">
                        By: <span className="font-semibold text-[#125007]">{property.developer_name}</span>
                      </p>
                    </div>
                  )}
                </div>
        ...
        <div className="text-center mt-12">
          <Link href="/properties">
            <button className="bg-[#125007] hover:bg-[#1d3610] text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 mx-auto">
