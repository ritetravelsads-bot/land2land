    ...
    <section className="w-full py-16 md:py-24 px-4 md:px-6 bg-background">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-end justify-between mb-10">
          ...
          <Button asChild variant="link" className="text-[#125007] hidden md:flex">
            ...
            <div className="relative h-full min-h-[600px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 text-white space-y-4">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/20">
                  ...
                  <Button className="bg-white text-[#125007] hover:bg-white/90">View Details</Button>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="relative h-full min-h-[290px]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white space-y-3">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-white/20">
                    ...
                    <Button size="sm" className="bg-white text-[#125007] hover:bg-white/90 text-xs">
                      Details
                    </Button>
                  </div>
                </div>
        ...
        <div className="flex justify-center mt-8 md:hidden">
          <Button asChild variant="outline" className="text-[#125007] border-2 bg-transparent">
            <Link href="/properties?segment=luxury">
