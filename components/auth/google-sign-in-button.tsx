...
export default function GoogleSignInButton({
  ...
  // If Firebase is not configured, render a disabled button
  if (!isFirebaseConfigured) {
    return (
      <Button
        ...
        variant="outline"
        disabled
        className="w-full h-9 text-xs flex items-center justify-center gap-2 opacity-50 cursor-not-allowed"
