      ...
      <Dialog open={showDetailDialog} onOpenChange={setShowDetailDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Full information about this enquiry.
            </DialogDescription>
          </DialogHeader>
          {selectedLead && (
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm font-semibold mt-1">{selectedLead.name}</p>
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold mt-1">{selectedLead.property_name || "General Enquiry"}</p>
                </div>
                <div>
                  <p className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Status</p>
                  <Badge className={`text-xs mt-1 ${STATUS_COLORS[selectedLead.status]}`}>
                    {selectedLead.status}
                  </Badge>
                </div>
                <div>
                  <p className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Priority</p>
                  <Badge className={`text-xs mt-1 ${PRIORITY_COLORS[selectedLead.priority]}`}>
              ...
              <div>
                ...
                <p className="text-sm">{formatDate(selectedLead.created_at)} at {formatTime(selectedLead.created_at)}</p>
              </div>
            </div>
          )}
        </DialogContent>
